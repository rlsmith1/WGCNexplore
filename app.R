...
footer <- fluidRow(
        ...
        box(title = tags$b("Contact me!"), width = 12, background = "light-blue",
            
            img(src = "NIMH_logo.png", width = 485/2, height = 127/2),
            ...
            img(src = "CAM_logo.jpeg", width = 485/2, height = 127/2)
                        ...
                        fluidRow(
                                ...
                                tabBox(
                                        ...
                                        tabPanel("Overlaps only functional enrichment", align = "center",
                                                 plotOutput("intersects_go", height = 900, width = 1000) %>%
                                                         withLoader(type = "image", loader = "dna-spinning.gif"),
                                        ...
                                        tabPanel("Overlapping modules functional enrichment", align = "center",
                                                 plotOutput("zoom_module_overlaps_go", height = 900, width = 1000) %>%
                                                         withLoader(type = "image", loader = "dna-spinning.gif"),
                                        ...
                                        tabPanel("Zoomed module functional enrichment", align = "center",
                                                 plotOutput("zoom_module_go", height = 900, width = 1000) %>%
                                                         withLoader(type = "image", loader = "dna-spinning.gif"),
...
server <- function(input, output, session) {
        ...
        observeEvent(input$go2, {
                ...
                show_modal_gif(
                        ...
                        text = paste0("Estimated run time: ", round(1.5*(1 + 2*length(overlap_mods))), "-", round(2.5*(1 + 2*length(overlap_mods))), " minutes")
                )
        ...
        }, height = 900, width = 1000) %>% bindEvent(input$go2)
